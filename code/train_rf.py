...
This script automates the training, evaluation, and saving of a Random
Forest classifier for the MNIST dataset. It follows these steps:
...
rf = MnistRfClassifier(n_iter=50)
...
rf.refit_for_test_set(X_train,y_train)
os.system('cls')
# Perform evaluation
